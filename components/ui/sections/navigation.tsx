...
export function Navigation() {
  ...
  return (
    <motion.nav
      initial={{ y: -100 }}
      animate={{ y: 0 }}
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#1A1A1A]/95 backdrop-blur-md border-b border-[#E16D3C]/20' : 'bg-[#1A1A1A]/90 backdrop-blur-md'
        }`}
    >
